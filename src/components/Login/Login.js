...
function Login() {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <br />
      <button onClick={fbLogin}>Sign In using FB</button>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <input type="password" password="password" onBlur={handleBlur} name="password" placeholder="Your password" required />
        <br />
